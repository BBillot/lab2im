...
def dice_evaluation(gt_folder,
    ...
    # load labels list
    label_list, neutral_labels = utils.get_list_labels(path_label_list=path_segmentation_label_list, FS_sort=True,
    ...
    for im_idx, (path_gt, path_seg) in enumerate(zip(list_path_gt_labels, list_path_segs)):
        ...
        # crop images
        gt_labels, cropping = edit_volume.crop_volume_around_region(gt_labels, margin=10)
        if n_dims == 2:
